                    ...
                    user && <div className="flex-none">
                        <div className="dropdown dropdown-end dropdown-hover">
                            ...
                            <ul tabIndex={0} className="menu menu-compact dropdown-content p-2 shadow bg-[#191f1325] rounded-box w-52">
                                ...
                                <span className='flex justify-between rounded-b-2xl p-3 hover:bg-slate-300 cursor-pointer text-[#f91aa3] bg-slate-100 font-bold hover:bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%'>Theme
                                    <input
