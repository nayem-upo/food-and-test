...
const Chefs = () => {
    ...
    return (
        <div ref={ref}>
            <h1 className='font-bold text-center my-4 md:text-5xl text-3xl text-[#60AA2D]'>Meet Our Chefs</h1>
            ...
            <div className='grid grid-rows-6 grid-flow-col gap-4 md:grid-rows-2 md:grid-flow-col mb-20 md:justify-evenly md:gap-10 justify-center md:mx-0'>
